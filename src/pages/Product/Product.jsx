    ...
    <div className="py-12 flex gap-12">
      ...
      <div className="flex-1 flex flex-col gap-7">
        ...
        <div className="flex flex-col gap-5">
          <button className="bg-red-500 hover:bg-green-500/90 px-6 rounded-md text-white font-medium tracking-wider transition w-full h-12 flex items-center justify-center">
