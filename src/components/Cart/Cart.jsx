	...
	return (
		<div className="absolute right-12 top-20 z-10 bg-white p-4 shadow-lg w-[400px] h-[700px] overflow-auto flex flex-col">
			...
			<div className="flex flex-col justify-between py-2 gap-4">
				<button
					type="button"
					className="bg-green-500/90 hover:bg-blue-500/90 px-6 rounded-md text-white font-medium tracking-wider transition h-12 items-center justify-center block"
				>
					PROCEDE TO CHECKOUT
				</button>
				...
				<button
					type="button"
					className="bg-red-500/90 hover:bg-blue-500/90 px-6 rounded-md text-white font-medium tracking-wider transition h-12 items-center justify-center block"
				>
					RESET CART
				</button>
			</div>
